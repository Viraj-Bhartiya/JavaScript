var allParticles = [], maxLevel = 5, useFill = false, data = [];
...
function draw() {
  ...
  for (var i = allParticles.length-1; i > -1; i--) {
    ...
    if (allParticles[i].vel.mag() < 0.03) {
  ...
  if (allParticles.length > 0) {
    ...
    //  if (useFill) {
    //    noStroke();
    //    fill(10+p1.life*7, 360, 360);
    //  } else {
    //    noFill();                                                             // 3,
    //    stroke(10+p1.life*7, 360, 360);
    //  }
    ...
    //}
     if (useFill) {
        noStroke();
        fill(p1.life*4, 360, 360);
      } else {
        noFill();                                                             // 3,
        stroke(p1.life*4, 360, 360);
      }
